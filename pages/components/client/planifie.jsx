...
import { planifie } from '../../../redux/action/sms'
...
const Planifie = () => {
    ...
    const onSubmit = async (e) => {
        ...
        const y = { form, contactss, groupess}
        await dispatch(planifie(y))}
    }
    ...
    return (
        <div className="col py-3">
            ...
            <form class='card container' onSubmit={onSubmit} >
                ...
                <input required name="date"  type="datetime-local" className="form-control" onChange={onChangeHandler}
                    />

<br></br>
                <button type='submit'  className='btn btn-outline-dark'><i className="fa fa-calendar-plus-o"></i> Planifier </button>
                <br></br>
            </form>
        </div>
    );
