        ...
        <section id="service">
            <div className="container my-5 py-5">
                ...
                <div className="row mt-5  ">
                    {
                        forfaits.forfaits.map(({ _id, nompack, prix, nbrsms, nbrentet, validite }) => (
                            <Rowfor3 id={_id} nompack={nompack} prix={prix} nbrsms={nbrsms} nbrentet={nbrentet} validite={validite} 
                            />
                        ))
                    }</div></div>
        </section>
